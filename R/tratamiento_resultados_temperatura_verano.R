...
setwd("D:/UDFnuevo")
getwd()
data_1cm <- read.table("tempsummer1cm.txt",sep = " ", header = F)
data_05cm <- read.table("tempsummer05cm.txt",sep = " ", header = F)
data_025cm <- read.table("tempsummer025cm.txt",sep = " ", header = F)
data_no_pcm <-read.table("tempsummernopcm.txt", sep= " ", header = F)
